   ...
   Api.AnaliseTelIndic(TelCli, setTe1, setNomeCli, setBtn1, setTe2, setBtn2, setDateInd)  
      ...
      const EnviandoMsg = () => {
        ...
        if(TelMsg === true){
            if(TelCli !== '' && NomeCli !== "") {
                setLoading(true);
                Api.EnviadoApp(NomeCli, TelCli, setAlertTipo, setAlert, setLoading, setModalCalend,  setBtn, setBtn1, setBtn2, setCodG, setSenha, setTentativa, setRobo, setNomeCli, setTelCli, setCodLast, setDateInd, setTelMsg, setTe1, setTe2);
            ...
            <>
                ...
                <Image source={require('../assets/futebol.gif')}  style={styles.ImageVer5 } />     
                       ...
                       <ReCAPTCHA
                          ...
                          onChange={onChangeRec}
                            ...
                            <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Gerar Código de Indicação</Text>
                          </TouchableHighlight>
             ...
             <Text  style={{ marginLeft:10, fontSize:15, color:"red"  }}>Excedeu o Limite de Tentativas!</Text> 
                   ...
                   <TouchableHighlight style={{width:150, height:50, backgroundColor:"#1ED31A", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>EnviandoMsg()}>
                    <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Indicar</Text>
            </TouchableHighlight>
