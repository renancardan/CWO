 ...
 const AtivandoInst = ()=>{
  ...
  const PegandoLig = ()=>{
   ...
   const ListandoOc = ()=>{
      ...
      setCarreg(true)
      Api.PegaCartao(IdCart,  setCarreg, setInfCart, setIdUser );
      ...
      console.log(int)
        ...
        //  });
         ...
         const CadastrandoAgora = () => {
          ...
          if(Tentativa <3){
            setLoading(true);
            Api.EntCod(IdCart, code, Tel, Nome, Tentativa, setTentativa, setIrEnt, setLoading, setTelMsg5, setUso, setAtivo );
          }else {
            console.log("tenrou")
            setIrEnt(false)
            setTelMsg5(false)
              ...
              <>
                ...
                <ScrollView>
                   ...
                   <View  style={styles.CaixadeapostaTitulo}  >
                    ...
                    <Text style={{fontWeight:"bold", marginLeft:10, fontSize:20  }}>Editando Cartão</Text> <View  style={styles.fechaModal} ><TouchableHighlight onPress={() =>Siarnota()}><Text>X</Text></TouchableHighlight></View>
                      </View>
                      {AtiInst === false ?
                  ...
                  <Text  style={{ marginLeft:10, fontSize:15, color:"red"  }}>Seu Saldo de Cash Não é suficiente, para essa Transferência!</Text> 
                    ...
                    <TouchableHighlight style={{width:150, height:50, backgroundColor:"#1ED31A", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>GerarCod()}>
                      <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Gerar Código de Edição</Text>
                    </TouchableHighlight>
                   ...
                   <FontAwesome name="expeditedssl" size={40} color="black" />           
                    ...
                    <TouchableHighlight style={{width:150, height:50, backgroundColor:"#1ED31A", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>SacarCash()}>
                        <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Salvando a Edição</Text>
                      </TouchableHighlight>
      ...
      <Text style={styles.TexTitu} >Digite O Código que Recebeu no Seu WhatsApp</Text>
        ...
        <Image source={require('../assets/ios.svg')}  style={styles.ImageVer63 } />
          ...
          <TouchableHighlight  style={styles.BtnEdi} onPress={AbrirCriar} >
                        <Text style={styles.BtnText}>Editar Cartão</Text>
            </TouchableHighlight>
        ...
        {Ativo === true &&
         ...
         <Text style={{fontFamily:"Arial", fontSize:35, color:"#fff", fontWeight:"bold" }} >
          ...
          <View style={{width: 420, height:70, flex:1, flexDirection: "row", justifyContent:"space-between", marginTop:70, alignItems:"center"}}>
          <TouchableHighlight style={{padding:10, width:50, height:70, backgroundColor:"#FFFFFF", borderBottomRightRadius:10, borderTopRightRadius:10, flex:1, flexDirection: "row", justifyContent:"flex-end",  alignItems:"center"}}>
         <>
         ...
         <>
          ...
          <TouchableHighlight style={{padding:10, width:50, height:70, backgroundColor:"#60D76A" , borderBottomLeftRadius:10,  borderTopLeftRadius:10, flex:1, flexDirection: "row", justifyContent:"flex-start",  alignItems:"center"}}>
          <>
          ...
          <View style={{width:420,  flexDirection:"row", justifyContent:"center", alignContent:"center", flexWrap:"wrap", }}>
           <TouchableHighlight style={{width:100, margin:5, height:100,  justifyContent:"center", alignItems:"center"}}>
           <>
